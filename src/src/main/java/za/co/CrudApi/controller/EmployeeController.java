...
public class EmployeeController {
    ...
    @CrossOrigin
    @GetMapping("/searchByFirstNameOrIdNumberOrAccountNumber/{searchName}")
    public ResponseEntity<Employee> searchByFirstNameOrIdNumberOrAccountNumber(@PathVariable("searchName") String firstName, @PathVariable("searchName")
